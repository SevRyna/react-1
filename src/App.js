...
import AddProps from "./component/additional_properties";
  ...
  return (
    <Page>
      ...
      <Amenities
        ...
        hasGymhasPool={data.amenities.hasGym}
      ...
      <AddProps
        ...
        //check-in_instructions={data.additional_properties.check - in_instructions}
      />
